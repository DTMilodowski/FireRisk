...
def plot_FWI_indices_time_series_for_pixel(T,P,H,W,FFMC,DMC,DC,ISI,BUI,FWI,date,start_tstep,end_tstep,row,col):
    ...
    ax_c1.plot(dates[start_tstep:end_tstep],FFMC[start_tstep:end_tstep,row,col],'-',c=colour[1])
    ax_c2.plot(dates[start_tstep:end_tstep],DMC[start_tstep:end_tstep,row,col],'-',c=colour[2])
...
def plot_fuel_moisture_time_series_for_pixel(T,P,H,W,FFMC,DMC,DC,ISI,BUI,FWI,date,start_tstep,end_tstep,row,col):
    # fine fuel moisture
